      ...
      Messages: [
        {
          ...
          Subject: "Your Quickz Lifetime License Key",
          HTMLPart: `
            <h3>Thank you for purchasing Quickz Pro!</h3>
            <p>Hi ${name},</p>
